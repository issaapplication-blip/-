(() => {
  const run = () => {
    try {
      ...
      // Use the approved SVG for crisp, resolution-independent rendering.
      // Do not replace it with the old JPG or remove responsive image sources.
      const logoUrl = '/rafig-approved-logo.svg?v=20';
